...
abstract class $LoginResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({String token, String refreshToken, UserInfo user});
...
class _$UserInfoImpl implements _UserInfo {
  ...
  @override
  String toString() {
    return 'UserInfo(id: $id, firstName: $firstName, lastName: $lastName, email: $email, phoneNumber: $phoneNumber, username: $username, role: $role, apartmentNumber: $apartmentNumber)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, firstName, lastName, email,
      phoneNumber, username, role, apartmentNumber);
...
abstract class _UserInfo implements UserInfo {
  const factory _UserInfo(
      ...
      final String? apartmentNumber}) = _$UserInfoImpl;
